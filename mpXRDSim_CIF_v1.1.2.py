...
from pyqtgraph import SpinBox, ComboBox, mkPen, GraphicsLayoutWidget, TextItem, SignalProxy
...
detWLabel = QtGui.QLabel('Detector Width (mm):')
layout.addWidget(detWLabel,4,0)
detWLine = QtGui.QLineEdit('79.9')
layout.addWidget(detWLine,4,1)

detHLabel = QtGui.QLabel('Detector Height (mm):')
layout.addWidget(detHLabel,5,0)
detHLine = QtGui.QLineEdit('77.2')
...
poni = QtGui.QLabel('PONI1 = %0.2f; PONI2 = %0.2f' %(xSpin.value(),ySpin.value()+float(detHLine.text())))
poniFont = poni.font()
...
betLabel = QtGui.QLabel('beta (deg):')
...
gamLabel = QtGui.QLabel('gamma (deg):')
...
sgLabel = QtGui.QLabel('Space group')
...
# CIF File path
cifPathLabel = QtGui.QLabel('CIF File Path:')
layout.addWidget(cifPathLabel,9,2)
#cifPathLine = QtGui.QLineEdit('C:\\Users\\mahram\\Desktop\\Python codes\\XRD\\CIF Interactive\\RbBr_rt.cif')
cifPathLine = QtGui.QLineEdit('C:\\Users\\balder-user\\Desktop\\xrd_codes\\CIFs\\LaB6.cif')
...
message = QtGui.QLabel('Powder ring simulation')
...
vb = p1.vb
infoLabel = QtGui.QLabel('Mouse pointer info:')
